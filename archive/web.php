...
use App\Http\Controllers\LoginController; // 确保引入正确的控制器
...
Route::prefix('auth')->name('auth.')->group(function () {
    Route::middleware('guest')->group(function () {
        ...
        Route::get('/smtp/login', [LoginController_smtp::class, 'showLoginForm'])->name('auth.smtp.login');
        Route::post('/smtp/login', [LoginController_smtp::class, 'handleLogin'])->name('auth.smtp.login.post');
